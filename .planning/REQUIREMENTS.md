...
- [x] **CONT-04**: Content variant acquisition follows source-aware priority: abstract -> arXiv HTML -> source -> PDF
- [x] **CONT-05** [chosen for now]: System supports multiple parsing backends behind a common interface (Docling, Marker, GROBID) (source says "working hypothesis" -- one backend behind extensible interface may suffice for v1)
