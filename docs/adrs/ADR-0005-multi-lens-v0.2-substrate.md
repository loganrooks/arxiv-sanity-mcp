...
- **`lens=` parameter** on the four discovery MCP tools (`search_papers`, `browse_recent`, `find_related_papers`, `get_paper`), defaulting to a configurable preferred lens or to "all available."
